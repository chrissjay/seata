...
/**
 * The type sybase undo update executor.
 * @author ccg
 * @date 2019/3/25
 */
public class SybaseUndoUpdateExecutor extends AbstractUndoExecutor {
     ...
     */
    public SybaseUndoUpdateExecutor(SQLUndoLog sqlUndoLog) {
        super(sqlUndoLog);
    }
