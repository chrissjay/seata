 ...
 * @author sharajava
 */
public class SybaseInsertRecognizer extends BaseRecognizer implements SQLInsertRecognizer {
     ...
     * @param ast         the ast
     */
    public SybaseInsertRecognizer(String originalSQL, SQLStatement ast) {
        super(originalSQL);
