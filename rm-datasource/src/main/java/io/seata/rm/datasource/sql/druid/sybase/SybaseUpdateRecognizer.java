 ...
 * @author sharajava
 */
public class SybaseUpdateRecognizer extends BaseRecognizer implements SQLUpdateRecognizer {
     ...
     * @param ast         the ast
     */
    public SybaseUpdateRecognizer(String originalSQL, SQLStatement ast) {
        super(originalSQL);
