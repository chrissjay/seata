...
/**
 * The type sybase undo insert executor.
 * @author ccg
 * @date 2019/3/25
 */
public class SybaseUndoInsertExecutor extends AbstractUndoExecutor {
     ...
     */
    public SybaseUndoInsertExecutor(SQLUndoLog sqlUndoLog) {
        super(sqlUndoLog);
    }
